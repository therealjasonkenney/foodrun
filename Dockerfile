...
# Mount SECRET_KEY_BASE into the image.
RUN --mount=type=secret,id=secret_key_base,env=SECRET_KEY_BASE

# Only copy the final release from the build stage
COPY --from=builder --chown=nobody:root /app/_build/${MIX_ENV}/rel/foodrun ./
